...
namespace RDSCL
{
	...
	public partial class RD_Hole : UserControl
	{
        ...
        public static readonly DependencyProperty StrokeThicknessProperty =
            DependencyProperty.Register(nameof(StrokeThickness), typeof(int), typeof(RD_Hole), new PropertyMetadata(0));
		...
		private static void Callback_IsTwinkle(DependencyObject d, DependencyPropertyChangedEventArgs e)
		{
			...
			var twinkleModule = (System.Windows.Shapes.Ellipse)rD_Hole.Template.FindName("Content", rD_Hole);
