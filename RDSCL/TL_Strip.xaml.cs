...
namespace RDSCL
{
	...
	public partial class TL_Strip : UserControl
	{
		...
		public IList HolesContentColor
		{
			get { return (IList)GetValue(HolesContentColorProperty); }
			set { SetValue(HolesContentColorProperty, value); }
		}
		public static readonly DependencyProperty HolesContentColorProperty =
			DependencyProperty.Register(nameof(HolesContentColor), typeof(IList), typeof(TL_Strip), new PropertyMetadata(null));
